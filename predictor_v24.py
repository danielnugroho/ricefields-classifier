...
Sample
--model Indramayu_model_U256L3B32_lbs.keras --bounds B4-BOUNDS.txt --class CLASS_B4-2022 --datacube B4-2022_DATACUBE.nc --region 1
...
ap.add_argument("-b", "--bounds", required=True,
	help="path to bounding coordinates")
